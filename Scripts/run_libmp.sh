...
./run_bin.sh 2 mp_pingpong_kernel_stream 1>$ofile 2>$efile
...
./run_bin.sh 2 mp_pingpong_kernel_stream_latency 1>$ofile 2>$efile
...
./run_bin.sh 2 mp_pingpong_kernel_stream_latency_mpi 1>$ofile 2>$efile
...
./run_bin.sh 2 mp_producer_consumer_kernel_stream 1>$ofile 2>$efile
...
./run_bin.sh 2 mp_sendrecv_kernel_stream 1>$ofile 2>$efile
